	...
	<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
		...
		<form method="get" id="purchaseFiltersForm" class="p-4 md:p-5 lg:p-6 space-y-5">
			...
			<div class="flex flex-col gap-3 lg:flex-row lg:items-center">
				<button type="submit" class="w-full inline-flex items-center justify-center gap-1 md:gap-1.5 bg-green-600 text-white px-2.5 md:px-4 lg:px-5 py-1.5 md:py-2 lg:py-2.5 rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors text-xs md:text-sm">
				...
				<div class="w-full">
					...
					<div class="relative">
						<select id="purchaseExportSelect" class="w-full appearance-none border border-gray-300 rounded-lg px-3 md:px-4 py-2 md:py-3 pr-9 bg-gray-100 text-xs md:text-sm font-medium text-gray-700">
				...
				<button type="button" id="purchasePrintBtn" class="w-full inline-flex items-center justify-center gap-1 md:gap-1.5 bg-green-600 text-white px-2.5 md:px-4 lg:px-5 py-1.5 md:py-2 lg:py-2.5 rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors text-xs md:text-sm">
	...
	<div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8 overflow-hidden no-print">
		...
		<form method="get" id="consumptionFiltersForm" class="p-4 md:p-5 lg:p-6 space-y-5">
			...
			<div class="flex flex-col gap-3 lg:flex-row lg:items-center">
				...
				<button type="button" id="consumptionPrintBtn" class="w-full inline-flex items-center justify-center gap-1 md:gap-1.5 bg-green-600 text-white px-2.5 md:px-4 lg:px-5 py-1.5 md:py-2 lg:py-2.5 rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors text-xs md:text-sm">
					<i data-lucide="printer" class="w-3.5 h-3.5 md:w-4 md:h-4"></i>
					Print Consumption
				</button>
			</div>
...
<?php if (!empty($sectionsEnabled['purchase'])): ?>
<?php if ($canViewCosts): ?>
<div class="bg-white rounded-lg shadow-md border p-3 md:p-4 lg:p-5 no-print mb-6 md:mb-8">
...
<?php else: ?>
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex items-center justify-center p-6 text-sm text-gray-600 mb-6 md:mb-8">
...
<style>
	/* Remove focus ring and border color for input fields in reports page on tablet mode */
	@media (min-width: 768px) and (max-width: 1023px) {
		#purchaseFiltersForm input:focus,
		#purchaseFiltersForm select:focus,
		#purchaseFiltersForm textarea:focus,
		#consumptionFiltersForm input:focus,
		#consumptionFiltersForm select:focus,
		#consumptionFiltersForm textarea:focus {
