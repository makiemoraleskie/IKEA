...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6 mb-6 md:mb-8 max-w-full overflow-x-hidden">
	...
	<div class="bg-white rounded-lg shadow-md border border-gray-200 p-3 md:p-4 lg:p-5 relative">
		...
		<div class="flex flex-col">
			...
			<div class="text-xl md:text-2xl lg:text-3xl font-black tracking-tight text-green-600 mb-1.5 md:mb-2"><?php echo $uniqueSuppliers; ?></div>
	...
	<div class="bg-white rounded-lg shadow-md border border-gray-200 p-3 md:p-4 lg:p-5 relative">
		...
		<div class="flex flex-col">
			...
			<div class="text-xl md:text-2xl lg:text-3xl font-black tracking-tight text-green-600 mb-1.5 md:mb-2"><?php echo $uniqueItems; ?></div>
